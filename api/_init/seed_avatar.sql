...
INSERT INTO items (slug, name, description, slot, svg_markup, price, rarity, sort_order) VALUES
  ...
  ('hair-white-long', '백발 장발', '신비로운 백발 장발.', 'hair',
   '<g><path d="M92 158 A108 108 0 0 1 308 158 Q304 200 294 232 Q272 192 238 184 Q200 178 162 184 Q128 192 106 232 Q96 200 92 158 Z" fill="#f0f0f0" stroke="#aaa" stroke-width="2"/><path d="M96 222 Q88 340 122 430 Q132 436 144 430 Q112 348 116 220 Z" fill="#f0f0f0" stroke="#aaa" stroke-width="2"/><path d="M304 222 Q312 340 278 430 Q268 436 256 430 Q288 348 284 220 Z" fill="#f0f0f0" stroke="#aaa" stroke-width="2"/></g>',
   120, 'epic', 5);
